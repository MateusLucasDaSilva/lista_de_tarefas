...
EitherOf<Failure, Success> reject<Failure, Success>(Failure reject) => Reject<Failure, Success>(reject);
EitherOf<Failure, Success> resolve<Failure, Success>(Success resolve) => Resolve<Failure, Success>(resolve);
